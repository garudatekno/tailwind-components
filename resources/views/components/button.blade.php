...
<button {{ $attributes->merge(['class' => 'inline-flex items-center border border-transparent font-semibold shadow-sm '.$textColor.' '.$textHover.' bg-transparent '.$hasColorStyle.' hover:'.$btnHoverStyle.' focus:outline-none focus:ring-2 focus:ring-offset-2 focus:'.$btnFocusStyle.' '.$hasSize])}}> 
  {!!$content!!}
</button>